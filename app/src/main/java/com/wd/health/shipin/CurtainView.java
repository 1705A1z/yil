...
public class CurtainView extends RelativeLayout implements View.OnTouchListener {
    ...
    /** 广告的图片*/
    private RadioGroup img_curtain_ad;
    /** 上升动画时间 */
    ...
    private void init(Context context) {
        ...
        final View view = LayoutInflater.from(mContext).inflate(R.layout.curtainview, null);
        img_curtain_ad = (RadioGroup)view.findViewById(R.id.img_curtain_ad);
